...
const double GLOBAL_CONST_N = 500. ;
...
const double GLOBAL_CONST_ALPHA_ONE = 1.05 ;
const double GLOBAL_CONST_ALPHA_TWO = 3.0 ;
/* epsilon is probability of alpha one */
const double GLOBAL_CONST_EPSILON = -0.1 ;
const double GLOBAL_CONST_SELECTION  = .5 ;
const unsigned int GLOBAL_CONST_BOTTLENECK = 1000 ;
const double GLOBAL_CONST_PROBABILITY_BOTTLENECK = -0.1 ;
const int GLOBAL_CONST_NUMBER_EXPERIMENTS = 10;
